...
<nav class="navbar navbar-default topSection"  role="navigation">
  ...
  <!-- Collect the nav links, forms, and other content for toggling -->
    ...
    <ul class="nav navbar-nav nav-center aboutmenu">
      <li class="active rightMenu"><a  id="pedal" href="#">Pedal</a></li>
      <li class="rightMenu"><a id="acc" href="#">Acc</a></li>
	  <li class="rightMenu"><a  id="amp" href="#">Amp</a></li>
